const CACHE_NAME = 'alum-metal-web-v7';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './prices.json', './catalog.json', './calculator.json', './alloys.json', './manifest.webmanifest', './logo1.png', './Yekan.ttf', './site-hero.png', './factory-banner.jpg'];
